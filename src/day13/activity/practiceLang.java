...
public class practiceLang {
    public static void main(String[] args) {
        ...
        String endsWithSyntax = "public boolean endsWith(String suffix))";

        System.out.println("endswith()\nDescription: "+endsWithDes);
        System.out.println("");
        System.out.println("Syntax: " + endsWithSyntax);
        System.out.println("");
        //sample code
        String text = "Hello Romel";
        System.out.println("Does the text ends with Romel? "+text.endsWith("Romel"));
        System.out.println("Does the text ends with Ronald? "+text.endsWith("Ronald"));
        ...
        System.out.println("");
        String text5 = "Java Programming is fun!";

        
        int indexChar = text5.indexOf('P'); 
        System.out.println("1. Index of 'P': " + indexChar); 

        
        int indexSub = text5.indexOf("fun"); 
        System.out.println("2. Index of \"fun\": " + indexSub); 

        
        int indexWithOffset = text5.indexOf('a', 2); 
        System.out.println("3. Index of 'a' after index 2: " + indexWithOffset); 

        
        int notFound = text5.indexOf("Python"); 
        ...
        char[] characters = text6.toCharArray();
...
"        System.out.println(\"Last: \" + lastLetter);   // Output: a");
        ...
        char firstLetter = text7.charAt(0); 
        
        
        char lastLetter = text7.charAt(text7.length() - 1); 
